...
<a class="item" href="%s">
	...
	<div class="info">
		...
		<div class="forks">
			<div class="icon">
				<svg xmlns="http://www.w3.org/2000/svg" fill="#BBB5AC" aria-label="fork" role="img" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo-forked">
